...
const ToDo = () => {
  ...
  const fetchData = async () => {
    try {
      const response = await axios.get(`https://beindescipline-server.onrender.com/auth/app/${username}`);
  ...
  const handlePostItem = async (e) => {
    e.preventDefault();
    try {
      await axios.post(`https://beindescipline-server.onrender.com/auth/app/${username}`, {
  ...
  const handleDeleteItem = async (i) => {
    try {
      await axios.delete(`https://beindescipline-server.onrender.com/auth/app/${username}/${i}`);
